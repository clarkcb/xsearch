...
class SearchSettings(FindSettings):
    ...
    def __init__(self,
                 ...
                 in_lines_after_patterns: PatternSet | None = None,
                 in_lines_before_patterns: PatternSet | None = None,
                 line_color: Color = Color.GREEN,
                 lines_after: int = 0,
                 lines_after_to_patterns: PatternSet | None = None,
                 lines_after_until_patterns: PatternSet | None = None,
                 lines_before: int = 0,
                 max_depth: int = -1,
                 ...
                 out_lines_after_patterns: PatternSet | None = None,
                 out_lines_before_patterns: PatternSet | None = None,
                 ...
                 search_patterns: PatternSet | None = None,
