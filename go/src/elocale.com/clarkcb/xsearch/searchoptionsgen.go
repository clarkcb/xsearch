...
func GetSearchOptions() *SearchOptions {
	return &SearchOptions{
		[]*SearchOption{
			...
			&SearchOption{"", "archivesonly", "Search only archive files (also turns on searcharchives)"},
			...
			&SearchOption{"w", "maxlinelength", "Maximum number of characters to print out per line of result (default: 150)"},
