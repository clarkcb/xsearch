...
object SearchOptions {
  ...
  val argOptions = List(
    ...
    new ArgSearchOption("", "in-linesafterpattern",
      "Specify pattern to search the \"lines-after\" lines on (used with --numlinesafter)",
      (x: String, settings: SearchSettings) => { settings.inLinesAfterPatterns.add(x.r) }),
    new ArgSearchOption("", "out-linesafterpattern",
      "Specify pattern to filter the \"lines-after\" lines on (used with --numlinesafter)",
      (x: String, settings: SearchSettings) => { settings.outLinesAfterPatterns.add(x.r) }),
    new ArgSearchOption("", "in-linesbeforepattern",
      "Specify pattern to search the \"lines-before\" lines on (used with --numlinesbefore)",
      (x: String, settings: SearchSettings) => { settings.inLinesBeforePatterns.add(x.r) }),
    new ArgSearchOption("", "out-linesbeforepattern",
      "Specify pattern to filter the \"lines-before\" lines on (used with --numlinesbefore)",
      (x: String, settings: SearchSettings) => { settings.outLinesBeforePatterns.add(x.r) }),
