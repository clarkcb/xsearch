...
namespace cppsearch {
    SearchResultFormatter::SearchResultFormatter(const SearchSettings& ss) : settings(ss) {
    }
...
//                        formatted.substr(match_start_index + match_length);
    ...
    std::string SearchResultFormatter::single_line_format(const SearchFileResult& result) {
    ...
    std::string SearchResultFormatter::format(const SearchFileResult& result) {
