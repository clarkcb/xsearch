...
TEST_CASE("Verify single-line result equals expected", "[SearchResult]") {
    ...
    long mod_time = 0;
    auto file_result = cppfind::FileResult(path, file_name, cppfind::FileType::CODE, file_size, mod_time);
    ...
    auto result = cppsearch::SearchFileResult(file_result, pattern, line_num, match_start_idx, match_end_idx, line);
...
TEST_CASE("Verify single-line-longer-than-max_line_length result equals expected", "[SearchResult]") {
    ...
    uint64_t file_size = 0;
    long mod_time = 0;
    auto file_result = cppfind::FileResult(path, file_name, cppfind::FileType::TEXT, file_size, mod_time);
...
TEST_CASE("Verify binary result equals expected", "[SearchResult]") {
    ...
    uint64_t file_size = 0;
    long mod_time = 0;
    auto file_result = cppfind::FileResult(path, file_name, cppfind::FileType::BINARY, file_size, mod_time);
    unsigned long line_num = 0;
    unsigned long match_start_idx = 0;
    unsigned long match_end_idx = 0;
    auto result = cppsearch::SearchFileResult(file_result, pattern, line_num, match_start_idx, match_end_idx, "");
