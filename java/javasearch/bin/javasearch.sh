...
JAVAFIND_JAR="$JAVAFIND_PATH/lib/build/libs/lib-$JAVAFIND_VERSION.jar"
...
JAVASEARCH_LIB_JAR="$JAVASEARCH_PATH/lib/build/libs/lib-$JAVASEARCH_VERSION.jar"
...
JAVA_HOME="$JAVA_HOME_17" java -cp "$JAVASEARCH_CLASSPATH" javasearch.JavaSearch "$@"
