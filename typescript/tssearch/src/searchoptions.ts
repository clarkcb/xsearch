...
export class SearchOptions {
  ...
  constructor() {
    ...
    this.boolActionMap = {
      allmatches: (b: boolean, settings: SearchSettings) => {
        settings.firstMatch = !b;
      },
      archivesonly: (b: boolean, settings: SearchSettings) => {
        settings.archivesOnly = b;
      },
      colorize: (b: boolean, settings: SearchSettings) => {
        settings.colorize = b;
      },
      debug: (b: boolean, settings: SearchSettings) => {
        settings.debug = b;
      },
      defaultfiles: (b: boolean, settings: SearchSettings) => {
        settings.defaultFiles = b;
      },
      excludehidden: (b: boolean, settings: SearchSettings) => {
        settings.includeHidden = !b;
      },
      firstmatch: (b: boolean, settings: SearchSettings) => {
        settings.firstMatch = b;
      },
      followsymlinks: (b: boolean, settings: SearchSettings) => {
        settings.followSymlinks = b;
      },
      includehidden: (b: boolean, settings: SearchSettings) => {
        settings.includeHidden = b;
      },
      help: (b: boolean, settings: SearchSettings) => {
        settings.printUsage = b;
      },
      multilinesearch: (b: boolean, settings: SearchSettings) => {
        settings.multilineSearch = b;
      },
      nocolorize: (b: boolean, settings: SearchSettings) => {
        settings.colorize = !b;
      },
      nodefaultfiles: (b: boolean, settings: SearchSettings) => {
        settings.defaultFiles = !b;
      },
      nofollowsymlinks: (b: boolean, settings: SearchSettings) => {
        settings.followSymlinks = !b;
      },
      noprintdirs: (b: boolean, settings: SearchSettings) => {
        settings.printDirs = !b;
      },
      noprintfiles: (b: boolean, settings: SearchSettings) => {
        settings.printFiles = !b;
      },
      noprintlines: (b: boolean, settings: SearchSettings) => {
        settings.printLines = !b;
      },
      noprintmatches: (b: boolean, settings: SearchSettings) => {
        settings.printMatches = !b;
      },
      noprintresults: (b: boolean, settings: SearchSettings) => {
        settings.printResults = !b;
      },
      norecursive: (b: boolean, settings: SearchSettings) => {
        settings.recursive = !b;
      },
      nosearcharchives: (b: boolean, settings: SearchSettings) => {
        settings.searchArchives = !b;
      },
      printdirs: (b: boolean, settings: SearchSettings) => {
        settings.printDirs = b;
      },
      printfiles: (b: boolean, settings: SearchSettings) => {
        settings.printFiles = b;
      },
      printlines: (b: boolean, settings: SearchSettings) => {
        settings.printLines = b;
      },
      printmatches: (b: boolean, settings: SearchSettings) => {
        settings.printMatches = b;
      },
      printresults: (b: boolean, settings: SearchSettings) => {
        settings.printResults = b;
      },
      recursive: (b: boolean, settings: SearchSettings) => {
        settings.recursive = b;
      },
      searcharchives: (b: boolean, settings: SearchSettings) => {
        settings.searchArchives = b;
      },
      'sort-ascending': (b: boolean, settings: SearchSettings) => {
        settings.sortDescending = !b;
      },
      'sort-caseinsensitive': (b: boolean, settings: SearchSettings) => {
        settings.sortCaseInsensitive = b;
      },
      'sort-casesensitive': (b: boolean, settings: SearchSettings) => {
        settings.sortCaseInsensitive = !b;
      },
      'sort-descending': (b: boolean, settings: SearchSettings) => {
        settings.sortDescending = b;
      },
      uniquelines: (b: boolean, settings: SearchSettings) => {
        settings.uniqueLines = b;
      },
      verbose: (b: boolean, settings: SearchSettings) => {
        settings.verbose = b;
      },
      version: (b: boolean, settings: SearchSettings) => {
        settings.printVersion = b;
      },
    };

    this.stringActionMap = {
      encoding: (s: string, settings: SearchSettings) => {
        settings.textFileEncoding = s;
      },
      'in-archiveext': (s: string, settings: SearchSettings) => {
        settings.addInArchiveExtensions(s);
      },
      'in-archivefilepattern': (s: string, settings: SearchSettings) => {
        settings.addInArchiveFilePatterns(s);
      },
      'in-dirpattern': (s: string, settings: SearchSettings) => {
        settings.addInDirPatterns(s);
      },
      'in-ext': (s: string, settings: SearchSettings) => {
        settings.addInExtensions(s);
      },
      'in-filepattern': (s: string, settings: SearchSettings) => {
        settings.addInFilePatterns(s);
      },
      'in-filetype': (s: string, settings: SearchSettings) => {
        settings.addInFileTypes(s);
      },
      'in-linesafterpattern': (s: string, settings: SearchSettings) => {
        settings.addInLinesAfterPatterns(s);
      },
      'in-linesbeforepattern': (s: string, settings: SearchSettings) => {
        settings.addInLinesBeforePatterns(s);
      },
      linesaftertopattern: (s: string, settings: SearchSettings) => {
        settings.addLinesAfterToPatterns(s);
      },
      linesafteruntilpattern: (s: string, settings: SearchSettings) => {
        settings.addLinesAfterUntilPatterns(s);
      },
      maxlastmod: (s: string, settings: SearchSettings) => {
        settings.maxLastModFromString(s);
      },
      minlastmod: (s: string, settings: SearchSettings) => {
        settings.minLastModFromString(s);
      },
      'out-dirpattern': (s: string, settings: SearchSettings) => {
        settings.addOutDirPatterns(s);
      },
      'out-archiveext': (s: string, settings: SearchSettings) => {
        settings.addOutArchiveExtensions(s);
      },
      'out-archivefilepattern': (s: string, settings: SearchSettings) => {
        settings.addOutArchiveFilePatterns(s);
      },
      'out-ext': (s: string, settings: SearchSettings) => {
        settings.addOutExtensions(s);
      },
      'out-filepattern': (s: string, settings: SearchSettings) => {
        settings.addOutFilePatterns(s);
      },
      'out-filetype': (s: string, settings: SearchSettings) => {
        settings.addOutFileTypes(s);
      },
      'out-linesafterpattern': (s: string, settings: SearchSettings) => {
        settings.addOutLinesAfterPatterns(s);
      },
      'out-linesbeforepattern': (s: string, settings: SearchSettings) => {
        settings.addOutLinesBeforePatterns(s);
      },
      path: (s: string, settings: SearchSettings) => {
        settings.paths.push(s);
      },
      searchpattern: (s: string, settings: SearchSettings) => {
        settings.addSearchPatterns(s);
      },
      'sort-by': (s: string, settings: SearchSettings) => {
        settings.sortBy = SortUtil.nameToSortBy(s);
      },
    };

    this.intActionMap = {
      linesafter: (i: number, settings: SearchSettings) => {
        settings.linesAfter = i;
      },
      linesbefore: (i: number, settings: SearchSettings) => {
        settings.linesBefore = i;
      },
      maxdepth: (i: number, settings: SearchSettings) => {
        settings.maxDepth = i;
      },
      maxlinelength: (i: number, settings: SearchSettings) => {
        settings.maxLineLength = i;
      },
      maxsize: (i: number, settings: SearchSettings) => {
        settings.maxSize = i;
      },
      mindepth: (i: number, settings: SearchSettings) => {
        settings.minDepth = i;
      },
      minsize: (i: number, settings: SearchSettings) => {
        settings.minSize = i;
      },
    };
  ...
  private setOptionsFromJsonFile(): void {
    ...
    if (
      ...
      Array.isArray(obj['searchoptions'])
    ) {
  ...
  public settingsFromArgs(
    args: string[],
    cb: (err: Error | undefined, settings: SearchSettings) => void,
  ): void {
  ...
  private getUsageString(): string {
    let usage: string =
      'Usage:\n tssearch [options] -s <searchpattern>' + ' <path> [<path> ...]\n\nOptions:\n';
