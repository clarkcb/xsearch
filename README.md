...
* [Clojure](http://clojure.org/) -
  ...
  version of the search tool is very incomplete and untouched for several years,
  but I'm really looking forward to getting back to it. I remember thinking that
  I might eventually conclude that it's my favorite language of the bunch, but
  that was before I worked with some of the others. It will be interesting to
  see if I end up feeling the same way or not.
...
* [Node.js](http://nodejs.org/) -
  ...
  like the idea that a developer can use one language for frontend and backend
...
* [Ruby](https://www.ruby-lang.org/) -
  ...
  blocks, but that's definitely nitpicking.
...
* [Scala](http://www.scala-lang.org/) -
  ...
  functional style as I started to understand it better. This is how the
...
* Functional - Now that I have become familiar with functional programming, I
  ...
  and within reason). I don't mean to say that a language has to be 100%
  functional, but just provide the ability to use it in a meaningful way.
...
* Quick to develop in - Any language will be quick to develop in for the developer
  that has a lot of experience with that language, but I find it interesting
  when a language is quick to develop in with minimal knowledge and experience.

* Comfortable - This is just the idea of having a level of familiarity with a language
  that makes the developer feel very comfortable with the language. This comes
  with experience, but depending on the language it can start to feel comfortable
  quickly.
...
1. Haskell
   ...
   - Quick to develop in - yes, but it took a while to get there
