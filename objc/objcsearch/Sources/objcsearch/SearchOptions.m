...
- (NSDictionary<NSString*,BoolActionBlockType>*) getBoolActionDict {
    return @{
        ...
        @"noprintmatches" : [^void (BOOL b, SearchSettings *ss) { ss.printMatches = !b; } copy],
        @"noprintresults" : [^void (BOOL b, SearchSettings *ss) { ss.printResults = !b; } copy],
        ...
        @"printmatches" : [^void (BOOL b, SearchSettings *ss) { ss.printMatches = b; } copy],
        @"printresults" : [^void (BOOL b, SearchSettings *ss) { ss.printResults = b; } copy],
