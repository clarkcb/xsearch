...
boolActions = [ ("allmatches", \ss b -> ss {firstMatch=not b})
              ...
              , ("noprintmatches", \ss b -> ss {printMatches=not b})
              , ("noprintresults", \ss b -> ss {printResults=not b})
              ...
              , ("printmatches", \ss b -> ss {printMatches=b})
              , ("printresults", \ss b -> ss {printResults=b})
